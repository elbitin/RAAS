...
{
    static class Program : Object
    {
        static System.Threading.Mutex connectSharesMutex;
        ...
        {
            bool result;
            connectSharesMutex = new System.Threading.Mutex(true, "raasclientconnectshares", out result);
            if (!result)
                return;
            if (AdminRightsHelper.IsAdministrator())
                return;
            Log.Logger = RAASClientLogHelper.CreateDefaultRAASClientLogger("connectshares");
