...
{
    class RAASClientLogHelper
    {
        private const String COMPANY_NAME = "Elbitin";
        private const String PROGRAM_NAME = "RAAS Client";
        private const String MINIMUM_LOGLEVEL_REGISTRY_STRING = "minimumLogLevelApplications";
        ...
        public static ILogger CreateDefaultRAASClientLogger(String programName)
        {
            ...
            String logPath =  Path.Combine(RAASClientPathHelper.GetAppDataRAASClientLogsPath(), programName + "-.dat");
